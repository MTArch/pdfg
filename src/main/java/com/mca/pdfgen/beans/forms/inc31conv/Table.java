...
public class Table {
    ...
    public boolean equals(Object other) {
        ...
        return (((this.tableDetails == rhs.tableDetails)||((this.tableDetails!= null)&&this.tableDetails.equals(rhs.tableDetails)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
