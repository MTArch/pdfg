...
public class Description__2 {
    ...
    public Description__2 withArticletype(String articletype) {
        this.articletype = articletype;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((this.checkboxifaltered == rhs.checkboxifaltered)||((this.checkboxifaltered!= null)&&this.checkboxifaltered.equals(rhs.checkboxifaltered)))&&((this.articletype == rhs.articletype)||((this.articletype!= null)&&this.articletype.equals(rhs.articletype))))&&((this.checkboxifapplicable == rhs.checkboxifapplicable)||((this.checkboxifapplicable!= null)&&this.checkboxifapplicable.equals(rhs.checkboxifapplicable))))&&((this.articlenum == rhs.articlenum)||((this.articlenum!= null)&&this.articlenum.equals(rhs.articlenum))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.articledescription == rhs.articledescription)||((this.articledescription!= null)&&this.articledescription.equals(rhs.articledescription))));
    }
