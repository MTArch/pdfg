...
@JsonPropertyOrder(
	{ "witnessDetails", "companyName", "subscriberDetails", "formIntegrationId", "table", "tableName" })
...
public class FormData
{
	...
	public String toString()
	{
		...
		sb.append(FormData.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
	...
	public boolean equals(Object other)
	{
		...
		return ((((((((this.witnessDetails == rhs.witnessDetails)
				|| ((this.witnessDetails != null) && this.witnessDetails.equals(rhs.witnessDetails)))
				&& ((this.companyName == rhs.companyName)
						|| ((this.companyName != null) && this.companyName.equals(rhs.companyName))))
				&& ((this.subscriberDetails == rhs.subscriberDetails)
						|| ((this.subscriberDetails != null) && this.subscriberDetails.equals(rhs.subscriberDetails))))
				&& ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null)
						&& this.additionalProperties.equals(rhs.additionalProperties))))
				&& ((this.formIntegrationId == rhs.formIntegrationId)
						|| ((this.formIntegrationId != null) && this.formIntegrationId.equals(rhs.formIntegrationId))))
				&& ((this.table == rhs.table) || ((this.table != null) && this.table.equals(rhs.table))))
