...
public class Meeting
{
	...
	public Meeting withArticletype(String articletype)
	{
		this.articletype = articletype;
		return this;
	}
	...
	public Meeting withDescription(List<Description__2> description)
	{
		this.description = description;
		return this;
	}
	...
	public Meeting withAdditionalProperty(String name, Object value)
	{
		this.additionalProperties.put(name, value);
		return this;
	}
	...
	public String toString()
	{
		...
		sb.append(Meeting.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
