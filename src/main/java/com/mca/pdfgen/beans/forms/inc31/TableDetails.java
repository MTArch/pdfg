...
@JsonPropertyOrder(
	{ "shareCapitalDetails", "managementAndBoard", "meetings" })
...
public class TableDetails
{
	...
	public String toString()
	{
		...
		sb.append(TableDetails.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
	...
	public boolean equals(Object other)
	{
		...
		return (((((this.managementAndBoard == rhs.managementAndBoard)
				|| ((this.managementAndBoard != null) && this.managementAndBoard.equals(rhs.managementAndBoard)))
				&& ((this.meetings == rhs.meetings) || ((this.meetings != null) && this.meetings.equals(rhs.meetings))))
				&& ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null)
						&& this.additionalProperties.equals(rhs.additionalProperties))))
				&& ((this.shareCapitalDetails == rhs.shareCapitalDetails) || ((this.shareCapitalDetails != null)
						&& this.shareCapitalDetails.equals(rhs.shareCapitalDetails))));
	}
