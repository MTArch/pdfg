...
@JsonPropertyOrder(
	{ "witnessPlace", "dscCount1", "witnessName", "witnessSerialNo", "witnessPassportDinPan", "witnessAddrDescOccpn" })
...
public class WitnessDetails
{
	...
	public String toString()
	{
		...
		sb.append(WitnessDetails.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
	...
	public boolean equals(Object other)
	{
		...
		return ((((((((this.witnessPlace == rhs.witnessPlace)
				|| ((this.witnessPlace != null) && this.witnessPlace.equals(rhs.witnessPlace)))
				&& ((this.dscCount1 == rhs.dscCount1)
						|| ((this.dscCount1 != null) && this.dscCount1.equals(rhs.dscCount1))))
				&& ((this.witnessName == rhs.witnessName)
						|| ((this.witnessName != null) && this.witnessName.equals(rhs.witnessName))))
				&& ((this.witnessSerialNo == rhs.witnessSerialNo)
						|| ((this.witnessSerialNo != null) && this.witnessSerialNo.equals(rhs.witnessSerialNo))))
				&& ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null)
						&& this.additionalProperties.equals(rhs.additionalProperties))))
				&& ((this.witnessPassportDinPan == rhs.witnessPassportDinPan) || ((this.witnessPassportDinPan != null)
						&& this.witnessPassportDinPan.equals(rhs.witnessPassportDinPan))))
				&& ((this.witnessAddrDescOccpn == rhs.witnessAddrDescOccpn) || ((this.witnessAddrDescOccpn != null)
						&& this.witnessAddrDescOccpn.equals(rhs.witnessAddrDescOccpn))));
	}
