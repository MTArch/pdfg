...
public class AfData {
    ...
    public String toString() {
        ...
        sb.append(AfData.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.afBoundData == rhs.afBoundData)||((this.afBoundData!= null)&&this.afBoundData.equals(rhs.afBoundData)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.afUnboundData == rhs.afUnboundData)||((this.afUnboundData!= null)&&this.afUnboundData.equals(rhs.afUnboundData))))&&((this.afSubmissionInfo == rhs.afSubmissionInfo)||((this.afSubmissionInfo!= null)&&this.afSubmissionInfo.equals(rhs.afSubmissionInfo))));
    }
