...
@JsonPropertyOrder(
	{ "requestType", "serveAction", "SRFOStatus", "linking", "formName", "integrationId", "formData", "formDescription",
			"formVersion", "parentServiceRequestId", "userId", "srn" })
...
public class RequestBody
{
	...
	public String toString()
	{
		...
		sb.append(RequestBody.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
	...
	public boolean equals(Object other)
	{
		...
		return ((((((((((((((this.sRFOStatus == rhs.sRFOStatus)
				|| ((this.sRFOStatus != null) && this.sRFOStatus.equals(rhs.sRFOStatus)))
				&& ((this.requestType == rhs.requestType)
						|| ((this.requestType != null) && this.requestType.equals(rhs.requestType))))
				&& ((this.serveAction == rhs.serveAction)
						|| ((this.serveAction != null) && this.serveAction.equals(rhs.serveAction))))
				&& ((this.linking == rhs.linking) || ((this.linking != null) && this.linking.equals(rhs.linking))))
				&& ((this.integrationId == rhs.integrationId)
						|| ((this.integrationId != null) && this.integrationId.equals(rhs.integrationId))))
				&& ((this.formDescription == rhs.formDescription)
						|| ((this.formDescription != null) && this.formDescription.equals(rhs.formDescription))))
				&& ((this.formVersion == rhs.formVersion)
						|| ((this.formVersion != null) && this.formVersion.equals(rhs.formVersion))))
				&& ((this.userId == rhs.userId) || ((this.userId != null) && this.userId.equals(rhs.userId))))
				&& ((this.srn == rhs.srn) || ((this.srn != null) && this.srn.equals(rhs.srn))))
				&& ((this.formName == rhs.formName) || ((this.formName != null) && this.formName.equals(rhs.formName))))
				&& ((this.formData == rhs.formData) || ((this.formData != null) && this.formData.equals(rhs.formData))))
				&& ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null)
						&& this.additionalProperties.equals(rhs.additionalProperties))))
				&& ((this.parentServiceRequestId == rhs.parentServiceRequestId)
						|| ((this.parentServiceRequestId != null)
								&& this.parentServiceRequestId.equals(rhs.parentServiceRequestId))));
	}
