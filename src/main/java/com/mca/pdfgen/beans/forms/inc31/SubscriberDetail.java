...
@JsonPropertyOrder(
	{ "subSerialNo", "subSignedPlace", "subscriberName", "subPassportdinpan", "dscCount" })
...
public class SubscriberDetail
{
	...
	public String toString()
	{
		...
		sb.append(SubscriberDetail.class.getName()).append('@')
	...
	public boolean equals(Object other)
	{
		...
		return (((((((this.subSerialNo == rhs.subSerialNo)
				|| ((this.subSerialNo != null) && this.subSerialNo.equals(rhs.subSerialNo)))
				&& ((this.subSignedPlace == rhs.subSignedPlace)
						|| ((this.subSignedPlace != null) && this.subSignedPlace.equals(rhs.subSignedPlace))))
				&& ((this.subscriberName == rhs.subscriberName)
						|| ((this.subscriberName != null) && this.subscriberName.equals(rhs.subscriberName))))
				&& ((this.subPassportdinpan == rhs.subPassportdinpan)
						|| ((this.subPassportdinpan != null) && this.subPassportdinpan.equals(rhs.subPassportdinpan))))
				&& ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null)
						&& this.additionalProperties.equals(rhs.additionalProperties))))
				&& ((this.dscCount == rhs.dscCount)
						|| ((this.dscCount != null) && this.dscCount.equals(rhs.dscCount))));
	}
