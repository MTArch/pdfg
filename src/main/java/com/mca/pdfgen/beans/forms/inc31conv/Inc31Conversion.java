...
public class Inc31Conversion {
    ...
    public Inc31Conversion withRequestBody(RequestBody requestBody) {
        this.requestBody = requestBody;
        return this;
    }
    ...
    public Inc31Conversion withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Inc31Conversion.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Inc31Conversion) == false) {
            return false;
        }
        Inc31Conversion rhs = ((Inc31Conversion) other);
