...
public class AfSubmissionInfo {
    ...
    public String toString() {
        ...
        sb.append(AfSubmissionInfo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("signers");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((this.signers == rhs.signers)||((this.signers!= null)&&this.signers.equals(rhs.signers)))&&((this.afSubmissionTime == rhs.afSubmissionTime)||((this.afSubmissionTime!= null)&&this.afSubmissionTime.equals(rhs.afSubmissionTime))))&&((this.afPath == rhs.afPath)||((this.afPath!= null)&&this.afPath.equals(rhs.afPath))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.lastFocusItem == rhs.lastFocusItem)||((this.lastFocusItem!= null)&&this.lastFocusItem.equals(rhs.lastFocusItem))))&&((this.computedMetaInfo == rhs.computedMetaInfo)||((this.computedMetaInfo!= null)&&this.computedMetaInfo.equals(rhs.computedMetaInfo))))&&((this.stateOverrides == rhs.stateOverrides)||((this.stateOverrides!= null)&&this.stateOverrides.equals(rhs.stateOverrides))));
    }
