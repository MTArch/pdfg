...
public class AfUnboundData {
    ...
    public AfUnboundData withData(Data__1 data) {
        this.data = data;
        return this;
    }
    ...
    public AfUnboundData withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AfUnboundData.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("data");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AfUnboundData) == false) {
            return false;
        }
        AfUnboundData rhs = ((AfUnboundData) other);
